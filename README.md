...
- 규칙 엔진 **112개** — 덱, 놓을 자리, 조커, 시작 손패 고르기, 준비 전 배치 은닉, 탈락/승리, 정보 은닉,
...
```bash
python3 -m http.server 8777      # 먼저 이 폴더를 띄워 두고
